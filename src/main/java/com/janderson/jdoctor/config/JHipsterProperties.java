...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "jDoctor@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "jDoctor API";

        private String description = "jDoctor API documentation";
